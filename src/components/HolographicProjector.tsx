...
export const HolographicProjector: React.FC<HolographicProjectorProps> = ({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-[80vh] flex flex-col rounded-3xl border border-[var(--border-color)] bg-[var(--bg-card)] shadow-[0_2px_6px_rgba(0,0,0,0.15)] backdrop-blur-2xl overflow-hidden">
        ...
        {/* Header bar */}
        <div className="relative z-10 flex items-center justify-between px-6 py-4 border-b border-[var(--border-color)] bg-[var(--bg-surface)]">
          <div className="flex items-center gap-3">
            <div className="relative flex h-3 w-3">
              <span className="relative inline-flex rounded-full h-3 w-3 bg-[var(--accent-primary)]"></span>
            </div>
            <div>
              <h3 className="font-mono text-xs uppercase tracking-widest text-indigo-400 font-bold">Ananya Holocore Projection Link</h3>
