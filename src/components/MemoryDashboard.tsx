      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute inset-y-0 right-0 w-full max-w-lg bg-[#020206]/95 border-l border-[var(--border-color)] backdrop-blur-2xl z-50 flex flex-col shadow-[0_2px_6px_rgba(0,0,0,0.15)]"
          >
            {/* Header */}
            ...
            <div className="px-6 py-4 bg-white/5 border-b border-white/5 flex items-center justify-between gap-2.5">
              <span className="text-[10px] text-slate-400 font-mono">
                💡 Ananya remembers these details naturally as you chat.
              </span>
              {!isAdding && (
                <button
                  ...
                  <form onSubmit={handleManualAdd} className="p-5 space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="e.g. The user's startup is called Ananya, a voice AI platform."
                        required
                ...
                {filteredMemories.length === 0 ? (
                  ...
                  >
                    ...
                    <p className="text-xs max-w-xs mt-1.5 leading-relaxed font-mono">
                      {activeTab === "all" 
                        ? "Start talking aloud with Ananya! Her background consolidator analyzes transcript slices and builds a life context naturally."
                        : `No persistent recollections saved in Category "${categoryConfig[activeTab as MemoryCategory]?.label}". Add one or speak with Ananya.`}
                    </p>
                  </motion.div>
                ) : (
